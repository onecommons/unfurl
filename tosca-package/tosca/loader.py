        ...
        if names[0] == "tosca_repositories":
            ...
            if repo_path:
                if len(names) == 2:
                    ...
                    if os.path.isfile(origin_path + ".py"):
                        # XXX check if yaml also exists and is newer than py and py is autogenerated return yaml
                        origin_path += ".py"
                    else:
                        if os.path.isfile(origin_path + ".yaml"):
                            origin_path += ".yaml"
                        else:
                            return None
