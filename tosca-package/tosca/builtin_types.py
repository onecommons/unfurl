# Generated by tosca.yaml2python from unfurl/vendor/tosca/vendor/toscaparser/elements/TOSCA_definition_1_3.yaml at 2026-02-13T21:47:19 overwrite not modified (change to "overwrite ok" to allow)
"""
...
class artifacts(Namespace):
    ...
    class TemplateJinja2(Template):
        ...
        _type_name = "tosca.artifacts.template.Jinja2"

    class TemplateTwig(Template):
        """Twig template file"""

        _type_name = "tosca.artifacts.template.Twig"
...
class nodes(Namespace):
    ...
    class Compute(AbstractCompute):
        ...
        host: "capabilities.Compute" = Capability(  # type: ignore[assignment]
    ...
    class ContainerRuntimeDocker(ContainerRuntime):
        ...
        host_capability: "capabilities.ContainerDocker" = Capability(  # type: ignore[assignment]
            name="host",
    ...
    class ContainerApplicationDocker(ContainerApplication):
        ...
        host: Union["relationships.HostedOn", "nodes.ContainerRuntime", "capabilities.ContainerDocker"]  # type: ignore[assignment]
