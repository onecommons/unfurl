# Generated by tosca.yaml2python from unfurl/tosca_plugins/k8s.yaml at 2025-03-14T22:10:50 overwrite not modified (change to "overwrite ok" to allow)
...
class unfurl_relationships_ConnectsTo_K8sCluster(tosca.relationships.ConnectsTo):
    ...
    KUBECONFIG: Union["unfurl_datatypes_EnvVar", None] = Property(
    ...
    token: Union["unfurl_datatypes_EnvVar", None] = Property(
