# Generated by tosca.yaml2python from unfurl/tosca_plugins/k8s.yaml at 2024-12-30T06:00:40 overwrite not modified (change to "overwrite ok" to allow)
...
class unfurl_nodes_K8sSecretResource(unfurl_nodes_K8sResource):  # type: ignore[override]
...
__kube_artifacts_kubectl: ArtifactEntity = artifact_AsdfTool(
    "kubectl",
    version="1.25.3",
    file="kubectl",
)
kube_artifacts.kubectl = __kube_artifacts_kubectl  # type: ignore[attr-defined]
