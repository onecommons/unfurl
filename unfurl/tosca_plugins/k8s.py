# Generated by tosca.yaml2python from unfurl/tosca_plugins/k8s.yaml at 2023-11-18T10:49:40 overwrite not modified (change to "ok" to allow)
...
class unfurl_relationships_ConnectsTo_K8sCluster(tosca.relationships.ConnectsTo):
    ...
    _target: "unfurl_capabilities_Endpoint_K8sCluster"
