# Generated by tosca.yaml2python from unfurl/tosca_plugins/k8s.yaml at 2025-05-04T06:19:51 overwrite not modified (change to "overwrite ok" to allow)
...
class unfurl_nodes_K8sRawResource(tosca.nodes.Root):
    ...
    name: str = Property(
        attribute=True, default=Eval({"eval": {"to_kubernetes_label": ".name"}})
    )
