# Generated by tosca.yaml2python from unfurl/tosca_plugins/k8s.yaml at 2025-03-15T05:55:12 overwrite not modified (change to "overwrite ok" to allow)
...
class unfurl_relationships_ConnectsTo_K8sCluster(tosca.relationships.ConnectsTo):
    ...
    token: Union["unfurl.datatypes.EnvVar", None] = Property(
