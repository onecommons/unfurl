# Generated by tosca.yaml2python from unfurl/tosca_plugins/artifacts.yaml at 2026-02-13T21:12:16 overwrite not modified (change to "overwrite ok" to allow)
...
"""
    ...
    def create(self, **kw: Any) -> Any:
        return unfurl.configurators.CmdConfigurator(
            cmd=Eval(
                (
                    "{{__python_executable}} -m ansible.cli.galaxy collection install "
                    "{{SELF.file}}{{SELF.version}}"
                )
            ),
            resultTemplate=Eval(
