# Generated by tosca.yaml2python from unfurl/tosca_plugins/artifacts.yaml at 2024-01-20T22:44:02 overwrite not modified (change to "overwrite ok" to allow)
...
class artifact_AnsibleCollection(tosca.artifacts.Root):
    ...
    @operation(environment={"ANSIBLE_GALAXY_SERVER": "https://old-galaxy.ansible.com/"})
    def check(self, **kw: Any) -> Any:
        return unfurl.configurators.CmdConfigurator(
