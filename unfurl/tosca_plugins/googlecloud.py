# Generated by tosca.yaml2python from unfurl/tosca_plugins/googlecloud.yaml at 2026-02-13T21:12:16 overwrite not modified (change to "overwrite ok" to allow)
...
class unfurl_nodes_GoogleCloudProject(unfurl.nodes.CloudAccount):
    ...
    account_id: str = Attribute(  # type: ignore[assignment]
        default=Eval({"eval": "project_id"})
    )
...
class unfurl_nodes_GoogleCloudOrganization(unfurl_nodes_GoogleCloudResource):
    ...
    type: str = "organization"  # type: ignore[assignment]
...
class unfurl_nodes_GoogleCloudFolder(unfurl_nodes_GoogleCloudResource):
    ...
    type: str = "folder"  # type: ignore[assignment]
    parent: str = Eval({"eval": ".parent::.name"})
