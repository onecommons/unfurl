# Generated by tosca.yaml2python from ../unfurl/tosca_plugins/tosca-ext.yaml at 2023-08-17 09:48:15.438931
...
class relationships(Namespace):
    ...
    class ConnectsToGoogleCloudProject(ConnectsToCloudAccount):
        ...
        def check(self):
            return configurators.GcpCheckGoogleCloudConnectionConfigurator()
...
class nodes(Namespace):
    ...
    class ArtifactInstaller(tosca.nodes.Root):
        ...
        def default(self):
            return configurators.DelegateConfigurator(
...
class groups(Namespace):
    class AnsibleInventoryGroup(tosca.groups.Root):
        ...
        hostvars: Dict = Property(default_factory=dict({}))
