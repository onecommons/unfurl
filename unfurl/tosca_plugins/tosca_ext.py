# Generated by tosca.yaml2python from unfurl/tosca_plugins/tosca-ext.yaml at 2025-06-01T12:37:08 overwrite not modified (change to "overwrite ok" to allow)
...
class relationships(Namespace):
    ...
    class ConnectsToAWSAccount(ConnectsToCloudAccount, ConnectsToObjectStorage):
        ...
        access_key: Union[str, None] = Eval("{{ SELF.AWS_ACCESS_KEY_ID }}")
        secret_key: Union[str, None] = Property(
            metadata={"sensitive": True},
    ...
    class ConnectsToDigitalOcean(ConnectsToCloudAccount, ConnectsToObjectStorage):
        ...
        access_key: Union[str, None] = Eval("{{ SELF.SPACES_ACCESS_KEY_ID }}")
        secret_key: Union[str, None] = Property(
            metadata={"sensitive": True},
            default=Eval("{{ SELF.SPACES_SECRET_ACCESS_KEY }}"),
        )
        endpoint_hostname: Union[str, None] = Eval(
            "{{ SELF.default_region }}.digitaloceanspaces.com"
        )
        """hostname"""
    ...
    class ConnectsToAzure(ConnectsToCloudAccount, ConnectsToObjectStorage):
       ...
       """
        ...
        access_key: Union[str, None] = Eval("{{ SELF.AZURE_STORAGE_ACCOUNT }}")
        secret_key: Union[str, None] = Property(
