# Generated by tosca.yaml2python from unfurl/tosca_plugins/tosca-ext.yaml at 2023-11-18T08:08:23 overwrite not modified (change to "ok" to allow)
...
class capabilities(Namespace):
    ...
    class EndpointSSH(EndpointAnsible):
        ...
        port: Union[
            "tosca.datatypes.NetworkPortDef", None
...
class relationships(Namespace):
    class InstalledBy(tosca.relationships.Root):
        ...
        _target: "capabilities.Installer"
    ...
    class ConnectsToAnsible(tosca.relationships.ConnectsTo):
       ...
       """
        ...
        _target: "capabilities.EndpointAnsible"
