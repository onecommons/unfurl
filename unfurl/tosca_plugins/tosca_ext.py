# Generated by tosca.yaml2python from unfurl/tosca_plugins/tosca-ext.yaml at 2026-02-13T21:47:19 overwrite not modified (change to "overwrite ok" to allow)
...
class artifacts(Namespace):
    ...
    class TemplateOperation(HasConfigurator):
        ...
        className: str = "unfurl.configurators.TemplateConfigurator"  # type: ignore[assignment]
        """Name of the python class that implements the configurator interface"""

        resultTemplate: Union[object, None] = Property(
            metadata={"inert": True}, default=None
        )
        """
    ...
    class ShellExecutable(TemplateOperation):
       ...
       """
        ...
        cwd: Union[str, None] = Property(metadata={"inert": True}, default=None)
       ...
       """
        ...
        echo: Union[bool, None] = Property(metadata={"inert": True}, default=None)
        """
       ...
       """
        ...
        outputsTemplate: Union[object, None] = Property(
            metadata={"inert": True}, default=None
        )
        """
       ...
       """
        ...
        dryrun: Union[str, None] = Property(metadata={"inert": True}, default=None)
        """
...
class capabilities(Namespace):
    ...
    class EndpointSSH(EndpointAnsible):
        ...
        port: Union["tosca.datatypes.NetworkPortDef", None] = tosca.datatypes.NetworkPortDef(22)  # type: ignore[assignment]
        '''sets "ansible_port"'''
...
class relationships(Namespace):
    ...
    class ConnectsToComputeMachines(tosca.relationships.ConnectsTo):
        ...
        _type_metadata = {"exclude-from-configuration": True}
    ...
    class ConnectsToObjectStorage(tosca.relationships.ConnectsTo):
        ...
        endpoint_hostname: Union[str, None] = None
        """hostname"""
    ...
    class ConnectsToAWSAccount(ConnectsToCloudAccount, ConnectsToObjectStorage):
        ...
        access_key: Union[str, None] = Eval("{{ SELF.AWS_ACCESS_KEY_ID }}")  # type: ignore[assignment]
        secret_key: Union[str, None] = Property(  # type: ignore[assignment]
            metadata={"sensitive": True},
            default=Eval("{{ SELF.AWS_SECRET_ACCESS_KEY }}"),
        )
        region: Union[str, None] = Eval("{{ SELF.AWS_DEFAULT_REGION }}")

    class ConnectsToDigitalOcean(ConnectsToCloudAccount, ConnectsToObjectStorage):
        ...
        SPACES_ACCESS_KEY_ID: Union["datatypes.EnvVar", None] = Property(
            metadata={"user_settable": True, "env_vars": ["SPACES_ACCESS_KEY_ID"]},
        ...
        access_key: Union[str, None] = Eval("{{ SELF.SPACES_ACCESS_KEY_ID }}")  # type: ignore[assignment]
        secret_key: Union[str, None] = Property(  # type: ignore[assignment]
            metadata={"sensitive": True},
        ...
        region: Union[str, None] = Eval("{{ SELF.default_region }}")

    class ConnectsToAzure(ConnectsToCloudAccount, ConnectsToObjectStorage):
       ...
       """
        ...
        access_key: Union[str, None] = Eval("{{ SELF.AZURE_STORAGE_ACCOUNT }}")  # type: ignore[assignment]
        secret_key: Union[str, None] = Property(  # type: ignore[assignment]
            metadata={"sensitive": True}, default=Eval("{{ SELF.AZURE_STORAGE_KEY }}")
        )
...
class nodes(Namespace):
    ...
    class ArtifactInstaller(tosca.nodes.Root):
        """
        Manages an artifact by delegating lifecycle operations to the artifact. Node templates of this type are "discovered" when artifacts need to be installed on an operation_host.
        """
