# Generated by tosca.yaml2python from unfurl/tosca_plugins/tosca-ext.yaml at 2025-06-01T14:54:38 overwrite not modified (change to "overwrite ok" to allow)
...
class relationships(Namespace):
    ...
    class ConnectsToAWSAccount(ConnectsToCloudAccount, ConnectsToObjectStorage):
        ...
        region: Union[str, None] = Eval("{{ SELF.AWS_DEFAULT_REGION }}")  # type: ignore[assignment]
